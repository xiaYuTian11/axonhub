...
func (_q *InvitationQuery) prepareQuery(ctx context.Context) error {
	...
	if invitation.Policy == nil {
		return errors.New("ent: uninitialized invitation.Policy (forgotten import ent/runtime?)")
	}
	if err := invitation.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
